...
export const resume = [
  {
    ...
    highlights: [
      ...
      "SageMaker pipelines serving 5K+ preds/day; cut latency 30% with CI/CD",
    ],
  },
  {
    ...
    highlights: [
      ...
      "Deployed Streamlit/PowerBI dashboards to 200+ staff",
    ],
  },
  {
...
export const education = [
  {
    ...
    degree: "M.S. Robotics & Autonomous Systems (AI Track) — GPA 3.83",
    period: "Expected May 2026",
  },
  {
    school: "BMS Institute of Technology (VTU)",
    degree: "B.E. Artificial Intelligence & Machine Learning (Honors) — GPA 3.89",
    period: "May 2023",
  },
];

export const skills = [
  "Python", "C++", "PyTorch", "TensorFlow", "Transformers/HF",
  "ONNX/TensorRT", "OpenCV", "LangChain/RAG", "SQL", "Airflow/PySpark",
  "AWS/GCP/Azure", "Docker", "FastAPI", "CI/CD (GitHub Actions)",
];
